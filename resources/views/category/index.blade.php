                    ...
                    <div class="modal-body" style="padding-top:0;">
                        ...
                        <div class="d-flex justify-content-center mt-4">
                            <button type="submit" class="btn"
                                style="background:#176c46; color:#fff; min-width:220px; border-radius:6px; font-weight:500; font-size:1.1rem; padding:10px 0; box-shadow:0 2px 8px rgba(23,108,70,0.08);">Crete Category</button>
                        </div>
                    </div>
                </form>
            </div>
