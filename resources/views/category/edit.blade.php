            ...
            <div class="col-lg-10 col-md-10 px-5 py-4" style="background:#e0e0e0; min-height:100vh;">
                <div class="bg-light rounded-3 p-5" style="min-height:80vh;">
                    <div class="mb-4 d-flex align-items-center">
                        <a href="{{url('/product')}}" class="btn btn-link fs-2 me-3" style="color:#444;"><i class="bi bi-arrow-left-circle"></i>
                        </a>
                            ...
                            <div class="col-md-6 mb-3 d-flex align-items-center">
                                <div>
                                    ...
                                    <div class="d-flex align-items-center mt-2">
                                        <img src="{{asset('assets/image/rtn.jpg')}}" alt="User" class="rounded-circle"
