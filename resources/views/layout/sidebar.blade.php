<div class="row g-0">
    <div class="col-lg-2 col-md-2 sidebar p-0">
        <nav class="nav flex-column" style="position: sticky; top: 86px;">
            <a class="nav-link {{ Request::is('/') ? 'active' : '' }}" href="{{url('/home')}}"><i
            ...
            @if(Auth::user()->role->role_name=='admin')
                ...
                <div class="nav-item">
                    ...
                    <div class="collapse ps-3 {{ Request::is(['product*','category*']) ? 'show' : '' }}"
                         id="productMenu">
                ...
                <div class="nav-item">
                    ...
                    <div class="collapse ps-3 {{ Request::is(['supplier*','purchase*']) ? 'show' : '' }}"
                         id="vendorMenu">
                ...
                <div class="nav-item">
                    ...
                    <div class="collapse ps-3 {{ Request::is('report/*') ? 'show' : '' }}" id="reportMenu">
                        <a href="{{ route('report.sale') }}"
                           class="nav-link {{ Request::is('report/sale*') ? 'active' : '' }}">
                            <i class="bi bi-bar-chart me-2"></i> Sale Report
                        </a>
                        <a href="{{ route('report.stock') }}"
                           class="nav-link {{ Request::is('report/stock*') ? 'active' : '' }}">
                            <i class="bi bi-box-seam me-2"></i> Stock Report
                        </a>
                        <a href="{{ route('report.purchase') }}"
                           class="nav-link {{ Request::is('report/purchase*') ? 'active' : '' }}">
